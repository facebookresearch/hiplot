...
var HiPlot = /** @class */ (function (_super) {
    ...
    HiPlot.prototype.sendMessage = function (type, data) {
    ...
    HiPlot.prototype._loadExperiment = function (experiment) {
        ...
        this.setState(function (state, props) {
            return __assign({ experiment: experiment, colormap: experiment.colormap, version: state.version + 1, loadStatus: HiPlotLoadStatus.Loaded, dp_lookup: dp_lookup, colorby: colorby, params_def: params_def, params_def_unfiltered: params_def_unfiltered, rows_filtered_filters: initFilters }, datasets);
        });
    };
