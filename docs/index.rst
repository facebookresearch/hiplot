...
* Let's see now how the training goes by adding a line plot. Right click the :code:`epoch` axis title and select :code:`Set as X axis`. Similary, set :code:`valid ppl` as the Y axis. Once you have done both, an XY line plot should appear below the parallel plot.
